...
generate_libsvm_mini_batches_with_format toc ../data/mnist/mini_batches/ ../data/mnist/raw_data $num
...
generate_libsvm_mini_batches_with_format csrvi ../data/mnist/mini_batches/ ../data/mnist/raw_data $num
...
generate_libsvm_mini_batches_with_format gzip ../data/mnist/mini_batches/ ../data/mnist/raw_data $num
echo "generating snappy format"
generate_libsvm_mini_batches_with_format snappy ../data/mnist/mini_batches/ ../data/mnist/raw_data $num
done